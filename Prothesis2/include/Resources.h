...
#define RES_FEEDBACK_VERT CINDER_RESOURCE( ../resources/, shaders/Feedback.vert, 130, GLSL )
#define RES_FEEDBACK_FRAG CINDER_RESOURCE( ../resources/, shaders/Feedback.frag, 131, GLSL )
